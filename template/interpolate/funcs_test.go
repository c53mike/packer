...
func TestFuncPackerBuild(t *testing.T) {
	...
	testCases := []cases{
		...
		{
			DataMap:     map[string]string{"PartyVar": "PartyVal" + gendata.PlaceholderMsg},
			ErrExpected: false,
			Template:    "{{ build `PartyVar` }}",
			OutVal:      "{{.PartyVar}}",
		},
		...
		{
			DataMap:     map[interface{}]interface{}{"PartyVar": "PartyVal" + gendata.PlaceholderMsg},
			ErrExpected: false,
			Template:    "{{ build `PartyVar` }}",
			OutVal:      "{{.PartyVar}}",
		},
		...
		{
			DataMap:     map[interface{}]interface{}{"BadVar": "PartyVal" + gendata.PlaceholderMsg},
			ErrExpected: true,
